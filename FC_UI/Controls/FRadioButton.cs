...
namespace FC_UI.Controls
{
    ...
    [Description("Позволяет пользователю выбрать или удалить соответствующий параметр.")]
    public partial class FRadioButton : UserControl
    {
        ...
        private Size size_fradiobutton = new Size();
        public enum Style
        {
            Default,
            Custom,
        ...
        [Description("Вкл/Выкл checked статус")]
        public bool Checked
        {
        ...
        [Category("FRadioButton")]
        [Description("Размер активации - маленького кружка \n(чем < value, тем больше кружок [значение должно быть четным], дефолт - 8)")]
        ...
        [Description("Вкл/Выкл градиент значения")]
        ...
        [Category("LinearGradient")]
        [Description("Цвет №1 для значения")]
        ...
        [Category("LinearGradient")]
        [Description("Цвет №2 для значения")]
        ...
        [Category("Effects")]
        [DefaultValue(true)]
        [Description("Вкл/Выкл эффекта круга при наведении/активации")]
        ...
        //
        private readonly Timer timer_effect_1 = new Timer() { Interval = 1 };
        [Category("Timers")]
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            size_fradiobutton = new Size(21, 21);
            rectangle_region = new Rectangle(15, base.Size.Height / 2 - 12, size_fradiobutton.Width, size_fradiobutton.Height);
        }
        #endregion
        ...
        private void Draw_Checked(Graphics graphics)
        {
            ...
            else graphics.FillPath(new SolidBrush(RGB ? DrawEngine.HSV_To_RGB(h, 1f, 1f) : ColorChecked), graphicsPath_temp);
        }
        private void Draw_Animation_Circles(Graphics graphics)
        {
            ...
            {
                Rectangle rectangle_circles = new Rectangle(
                    (15 + (25 / 2)) - (temp / 2),
