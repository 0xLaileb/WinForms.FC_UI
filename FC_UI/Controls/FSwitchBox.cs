...
namespace FC_UI.Controls
{
    ...
    [Description("Позволяет пользователю включить или выключить соответствующий параметр.")]
    public partial class FSwitchBox : UserControl
    {
        ...
        private Size size_fswitchbox = new Size();
        public enum Style
        {
            Default,
            Custom,
        ...
        [Category("FSwitchBox")]
        [Description("Цвет кружка внутри")]
        ...
        [Category("LinearGradient")]
        [Description("Цвет №1 для градиента значения")]
        ...
        [Category("LinearGradient")]
        [Description("Цвет №2 для градиента значения")]
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            size_fswitchbox = new Size(Width - tmp * 2, Height - tmp * 2);
            rectangle_region = new Rectangle(tmp, tmp, size_fswitchbox.Width, size_fswitchbox.Height);
        }
        #endregion
