...
namespace FC_UI.Controls
{
    ...
    public partial class FCheckBox : UserControl
    {
        ...
        private Size size_fcheckbox = new Size();
        public enum Style
        {
            Default,
            Custom,
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            size_fcheckbox = new Size(21, 21);
            rectangle_region = new Rectangle(15, Size.Height / 2 - 12, size_fcheckbox.Width, size_fcheckbox.Height);
        }
        #endregion
