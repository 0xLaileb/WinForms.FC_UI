...
namespace FC_UI.Controls
{
    ...
    [Description("Отображает рамку вокруг группы элементов управления с возможностью включения заголовка.")]
    ...
    public partial class FGroupBox : UserControl
    {
        ...
        private Size size_fgroupbox = new Size();
        public enum Style
        {
            Default,
            Custom,
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            size_fgroupbox = new Size(Width - tmp * 2, Height - tmp * 2);
            rectangle_region = new Rectangle(tmp, tmp, size_fgroupbox.Width, size_fgroupbox.Height);
        }
        #endregion
