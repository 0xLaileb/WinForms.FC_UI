...
public partial class ZColorPicker : UserControl
{
    ...
    public ZColorPicker()
    {
        ...
        CursorPos = new((float)pictureBox1.Height / 2, (float)pictureBox1.Height / 2);
    }
    #endregion
    ...
    private void pictureBox1_Paint(object sender, PaintEventArgs e)
    {
        ...
        e.Graphics.DrawEllipse(pen, CursorPos.X - 4, CursorPos.Y - 4, 8, 8);
    }
    private void pictureBox3_Paint(object sender, PaintEventArgs e)
    {
        using var gradientBrush = new LinearGradientBrush(new Point(0, 0), new Point(0, pictureBox3.Height), ((ValueBox)pictureBox3.Tag).Color, Color.Black);
        e.Graphics.FillRectangle(gradientBrush, pictureBox3.ClientRectangle);
        using var solidBrush = new SolidBrush(Color.DarkGray);
        e.Graphics.FillRectangle(solidBrush, 0, pictureBox3.Height * (1 - ((ValueBox)pictureBox3.Tag).Value) - 2, pictureBox3.Width, 4);
    }
    ...
    private void DrawWheel(float radius, Graphics graphics)
    {
        ...
        using var brush = GetBrush(BrushPath);
    ...
    private Color PickColor(float x, float y)
    {
        ...
        CursorPos = new(x1 + (float)pictureBox1.Width / 2, y1 + (float)pictureBox1.Height / 2);
