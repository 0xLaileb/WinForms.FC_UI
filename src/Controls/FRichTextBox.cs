...
public partial class FRichTextBox : UserControl
{
    ...
    private Size size_frichtextbox = new();
    ...
    public void Update_RichTextBox(bool Visible)
    {
        ...
        richTextBox.Location = new((Width / 2) - (richTextBox.Size.Width / 2), (Height / 2) - (richTextBox.Size.Height / 2));
    ...
    protected override void OnSizeChanged(EventArgs e)
    {
        ...
        size_frichtextbox = new(Width - tmp * 2, Height - tmp * 2);
        rectangle_region = new(tmp, tmp, size_frichtextbox.Width, size_frichtextbox.Height);
    }
    #endregion
